# Modelo de datos: Pantalla de inicio e imagen profesional (PresupuestosPro v1.1)

**Fecha**: 2026-09-19
**Spec**: [spec.md](./spec.md) · **Decisiones**: [research.md](./research.md)

## Lo primero: aquí no se guarda nada nuevo
...
| FR-001, FR-002, FR-004…FR-007 | [contracts/navegacion.md](./contracts/navegacion.md) |
| FR-008…FR-014 | [contracts/sistema-visual.md](./contracts/sistema-visual.md) |
| FR-019…FR-023 | [contracts/pdf-presentacion.md](./contracts/pdf-presentacion.md) |
| FR-024, FR-025, FR-026 | Por construcción: los módulos de cálculo, numeración y almacenamiento de la 001 no se tocan |
